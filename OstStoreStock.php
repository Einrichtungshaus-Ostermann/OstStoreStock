 ...
 *
 * Displays the currently available stock for every store for every article including
 * if the article is on display.
 *
 * 1.0.0
 * - initial release
 *
...
namespace OstStoreStock;

use Shopware\Components\Plugin;
use Shopware\Components\Plugin\Context;
use Symfony\Component\DependencyInjection\ContainerBuilder;

class OstStoreStock extends Plugin
{
    /**
     * ...
     *
    ...
    public function build(ContainerBuilder $container)
    {
        ...
        $container->setParameter('ost_store_stock.plugin_dir', $this->getPath() . '/');
        $container->setParameter('ost_store_stock.view_dir', $this->getPath() . '/Resources/views/');
